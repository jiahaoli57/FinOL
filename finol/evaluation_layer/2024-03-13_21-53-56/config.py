...
DATASET_NAME = "CRYPTO"  # Available options: NYSE(O), NYSE(N), DJIA, SP500, TSE, SSE, HSI, CMEG, CRYPTO, TUTORIAL
...
PLOT_ALL_1 = ["PPT", "SSPO", "RMR", "RPRT", "Best"]
PLOT_ALL_2 = ["AICTR", "KTPT", "WAAS", "CW-OGD", "Best"]
