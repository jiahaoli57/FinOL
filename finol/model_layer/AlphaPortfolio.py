...
class AlphaPortfolio(nn.Module):
    """
    AlphaPortfolio model for portfolio selection.
    ...
    The final output of the AlphaPortfolio model is a tensor of shape `(batch_size, num_assets)`, where each element
